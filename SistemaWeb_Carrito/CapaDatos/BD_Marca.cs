...
namespace CapaDatos
{
    public class BD_Marca //Para la tabla autor
    {
        public List<EN_Marca> Listar()
        {
            List<EN_Marca> lista = new List<EN_Marca>();
            try
            {
                using (SqlConnection oConexion = new SqlConnection(Conexion.cn))
                {
                    string query = "SELECT IDAutor, Nombre, Activo FROM Autor";
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader())/*Lee todos los resultados que aparecen en la ejecucion del select anter ior*/
                    {
                        ...
                        {
                            lista.Add(/*Agrega una nueva marca la lista*/
                                new EN_Marca()
                                {
            ...
            {
                lista = new List<EN_Marca>();
            }

            return lista;
        }

        public int Registrar(EN_Marca obj, out string Mensaje)//out indica parametro de salida
        {
            ...
            try
            {
                using (SqlConnection oConexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    /*Los primeros valores de estos parametros, es la del procedimiento del sql y el segundo de donde toma el valor (las propieaddes de la clase EN_Marca*/
        ...
        public bool Editar(EN_Marca obj, out string Mensaje)//out indica parametro de salida
        {
